...
with open(datedMenuName) as contentFile:
...
# Copy the dated file and overwrite the current version as the published name (this will be MobileMenu.html)
shutil.copyfile(resultFileName, "MobileMenu.html")
